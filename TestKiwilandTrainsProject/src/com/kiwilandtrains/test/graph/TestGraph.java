...
public class TestGraph extends TestCase {
	...
	public void testSearchWithDFS() {
		...
		assertEquals("E exists in the graph: " , true, 
				(CityGraphManager.getInstance().getCityGraph().DFSearch(CityGraphManager.getInstance().getCityGraph().getVertex("A", false), "E")));
		assertEquals("Z does not exist in the graph: " , false, 
				(CityGraphManager.getInstance().getCityGraph().DFSearch(CityGraphManager.getInstance().getCityGraph().getVertex("A", false), "E")));
	}
